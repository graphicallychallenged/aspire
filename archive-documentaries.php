...
<div id="documentaries-featured" class="featured-programs block block-inverse p-y-md">
  <div class="container">
    <h3>Featured Documentaries</h3>
    <hr>
    <?php echo do_shortcode('[wpv-view name="documentaries-featured"]'); ?>
...
<div class="site-container container" id="site-container">
  <div class="site-content row" id="site-content">
    <main class="site-main col-md-8" id="site-main" role="main">
      ...
      <?php echo do_shortcode('[wpv-view name="documentaries-non-featured"]'); ?>
