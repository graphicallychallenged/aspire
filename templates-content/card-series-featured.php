...
<div class="card mb-3" id="post-<?php the_ID(); ?>">
	...
	<div class="card-body">
      ...
      <?php
      if( get_the_term_list($entry_id, 'series-type') ) {

        echo get_the_term_list( $entry_id, 'series-type', '', ', ' );
      ...
      <a href="<?php echo get_the_permalink($entry_id); ?>">
        <?php echo get_the_title($entry_id); ?>
      </a>
    </h5>
	</div>
