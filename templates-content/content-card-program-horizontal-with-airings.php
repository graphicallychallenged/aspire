	...
	<div class="card-body">
		<div class="row">
	        ...
	        <div class="card-header">
	          <p class="mb-0">Next Airings <?php echo $parent_program_name; ?></p>
	        </div>

	        <ul class="list-group">
	          <?php
	            $upcoming_airings = uptv_get_upcoming_airings(1, $parent_content_id);
	            uptv_display_upcoming($upcoming_airings);
	          ?>
	        </ul>
