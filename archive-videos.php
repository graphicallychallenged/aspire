	...
	<div class="site-content row" id="site-content">
		<main class="site-main col-lg-12" id="site-main" role="main">
			...
			if(!is_paged()): ?>
				...
				<div id="videos-featured" class="videos-featured pt-3 pb-4">
					<h3>Featured Videos</h3>
					<hr>

					<?php
					$featured_videos = aspire_get_featured_videos(3);
						...
						echo '<div class="row">';
							...
							while ( $featured_videos->have_posts() ) : $featured_videos->the_post();
								...
								echo '<div class="col-md">';
									get_template_part( 'templates-content/card-video' );
								echo '</div>';
			...
			<?php
			$all_videos = aspire_get_all_videos();
			...
			if ( $all_videos->have_posts() ) :
				...
				<nav aria-label="Pagination">
					<ul class="pagination">
						<li class="page-item"><?php echo get_next_posts_link( 'Older Entries', $all_videos->max_num_pages ); ?></li>
