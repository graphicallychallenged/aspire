...
add_filter( 'post_class', 'aspire_capture_post_classes');

function aspire_capture_post_classes( $classes ) {
...
add_filter( 'body_class', 'aspire_capture_body_classes');

function aspire_capture_body_classes( $classes ) {
